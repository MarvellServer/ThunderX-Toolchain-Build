...
Source0:    /tmp/llvm/%{name}-%{version}.tar.gz
...
%prep
tar -xzvf /tmp/llvm/%{name}-%{version}.tar.gz -C ${RPM_SOURCE_DIR}/
...
%changelog
* Thu Jun 24 2020 Srikanth Yalavarthi <syalavarthi@marvell.com> - 9.0.0-20200624
