...
sed -i '1s/python/python3/' $RPM_BUILD_ROOT/opt/flang/9.0.0/share/opt-viewer/opt-diff.py
sed -i '1s/python/python3/' $RPM_BUILD_ROOT/opt/flang/9.0.0/share/opt-viewer/opt-stats.py
sed -i '1s/python/python3/' $RPM_BUILD_ROOT/opt/flang/9.0.0/share/opt-viewer/optrecord.py
sed -i '1s/python/python3/' $RPM_BUILD_ROOT/opt/flang/9.0.0/share/opt-viewer/opt-viewer.py
sed -i '1s/python/python3/' $RPM_BUILD_ROOT/opt/flang/9.0.0/bin/git-clang-format
sed -i '1s/python/python3/' $RPM_BUILD_ROOT/opt/flang/9.0.0/bin/hmaptool
sed -i '1s/python/python3/' $RPM_BUILD_ROOT/opt/flang/9.0.0/bin/scan-view
sed -i '1s/python/python3/' $RPM_BUILD_ROOT/opt/flang/9.0.0/share/clang/clang-format-diff.py
